...
import (
	...
	"github.com/hstores/keysmith/internal/controller"
	_ "github.com/hstores/keysmith/internal/metrics"
	"github.com/hstores/keysmith/internal/provider"
	"github.com/hstores/keysmith/internal/provider/aws"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4bbe2ea3.keysmith.io",
	...
	registry.Register(aws.New())
	registry.Register(vault.New())

	if err := (&controller.SecretRotationPolicyReconciler{
